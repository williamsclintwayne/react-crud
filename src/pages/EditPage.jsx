...
const EditPage = () => {
    ...
    const updateProduct = async(e) => {
        ...
        setIsLoading(true);
        try {
            await axios.put(`${VITE_BACKEND_URL}/api/product/${id}`, product);
                        ...
                        <div className="space-y-2">
                            <div>
                                ...
                                <input type="text" value={product.name} onChange={(e) => setProduct({...product, name: e.target.value})}
                                    ...
                                    focus:outline-none focus:shadow-outline focus:border-blue-200 placeholder-gray-400" 
                            ...
                            <div>
                                { !isLoading && 
                                (<button 
                                    className="block w-full mt-6 bg-blue-700 text-white rounded-sm 
                                    px-4 py-2 font-bold hover:bg-blue-600 hover:cursor-pointer">Update</button>) }
